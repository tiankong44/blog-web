...
<template>
  <div class="">
    <el-card class="box-card tiny-text">
      <span @mouseenter="getTopFiveViewBlog()">点击排行</span>
      <el-divider direction="vertical"></el-divider>
      <span @mouseenter="getNewFiveBlog()">最新文章</span>
      <el-divider direction="vertical"></el-divider>
      <span @mouseenter="getNewFiveCommentBlog()">最新评论</span>
...
export default {
  ...
  methods: {
    ...
    getNewFiveCommentBlog() {
      this.request
        .postJson(this.blogapi.getNewFiveCommentBlog)
        .then((res) => {
          if (res.code == 0) {
            this.blogList = res.data.blogList
          }
    ...
    getTopFiveViewBlog() {
      this.request
        .postJson(this.blogapi.getTopFiveViewBlog)
        .then((res) => {
          if (res.code == 0) {
            this.blogList = res.data.blogList
          }
